...
$_['text_success']           = 'Success: You have modified CardGate Crypto account details!';
$_['text_cardgatecrypto'] = '<a onclick="window.open(\'http://www.cardgate.com/\');"><img src="view/image/payment/cardgateplus.png" alt="CardGate Crypto" title="CardGate Crypto" style="border: 1px solid #EEEEEE;" /></a>';
