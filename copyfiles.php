...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgategiftcard.twig';
$dst = 'cardgate/admin/view/template/extension/payment/cardgategiftcard.twig';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../admin/view/template/extension/payment/cardgatepaysafecash.twig';
$dst = 'cardgate/admin/view/template/extension/payment/cardgatepaysafecash.twig';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgategiftcard.twig';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgategiftcard.twig';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../catalog/view/theme/default/template/extension/payment/cardgatepaysafecash.twig';
$dst = 'cardgate/catalog/view/theme/default/template/extension/payment/cardgatepaysafecash.twig';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
